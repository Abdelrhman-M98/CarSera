            ...
            children: [
              Text(
                ...
                style: getRegularStyle(
                    fontSize: FontSize.f18, color: ColorManager.primaryLight),
              ),
              Space(height: 5),
              Row(
                children: [
                  Text(
                    value,
                    style: getRegularStyle(color: ColorManager.offWhite),
                  ),
                  Text(
                    ' $unit',
                    style: getRegularStyle(color: ColorManager.offWhite),
    ...
    return Row(
      ...
      children: [
        ...
        Text(
          value,
          style: getRegularStyle(
              color: ColorManager.offWhite, fontSize: fontSize),
        )
      ],
    );
  }
                  ...
                  child: Column(
                    ...
                    children: [
                      Text(
                        ...
                        style: getMediumStyle(color: ColorManager.offWhite, fontSize: FontSize.f18),
                      ),
                      Space(height: 5),
                      Text(
                        widget.carDetails.model,
                        style:
                            getRegularStyle(color: ColorManager.offWhite),
                        maxLines: 2,
                        overflow: TextOverflow.ellipsis,
                      ),
                      Text(
