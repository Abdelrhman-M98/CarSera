          ...
          Center(
            child: Text(
              ...
              style: getSemiBoldStyle(
                  color: ColorManager.offWhite, fontSize: FontSize.f20),
            ),
          ),
          Space(height: 5),
          Center(
            child: Text(
              'abdelrahmanmahmo0ud@gmail.com',
              style: getMediumStyle(
                  color: ColorManager.offWhite, fontSize: FontSize.f16),
            ),
          ),
          Space(height: 30),
          Row(
              ...
              child: Column(
                children: [
                  ...
                  Text(
                    '10,000 LE',
                    style: getMediumStyle(
                        color: ColorManager.offWhite, fontSize: FontSize.f26),
                  ),
                  Space(height: 5),
                  Text(
                    'total balance',
                    style: getMediumStyle(color: ColorManager.primaryLight),
                  ),
                  Space(),
